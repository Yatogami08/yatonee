...
import '../yatogami_task/dailoz_addtask.dart';
import 'chitietlichsu.dart';
import 'lichsuitem.dart';


class lichsungay extends StatefulWidget {
  const lichsungay({Key? key}) : super(key: key);

  @override
  State<lichsungay> createState() => _DailozTaskState();
}

class _DailozTaskState extends State<lichsungay> {
  dynamic size;
  double height = 0.00;
  double width = 0.00;
  int isselected = 0;
