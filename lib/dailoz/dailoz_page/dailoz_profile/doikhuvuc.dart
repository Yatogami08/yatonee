...
class doikhuvuc extends StatefulWidget {
  const doikhuvuc({Key? key}) : super(key: key);

  @override
  State<doikhuvuc> createState() => _DailozWorkState();
}




class _DailozWorkState extends State<doikhuvuc> {
  dynamic size;
  double height = 0.00;
  double width = 0.00;
  @override
